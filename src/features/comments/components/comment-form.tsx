							...
							{isEditing ? (
								<div className="flex gap-2 w-full justify-end">
									<button
										type="button"
										onClick={onCancel}
										className="px-3 py-1.5 text-base font-semibold text-neutral-300 hover:text-white hover:bg-neutral-800 rounded-2xl transition-colors"
									>
										{m.comment_cancel()}
									</button>
									<button
										...
										className="px-3 py-1.5 text-base font-semibold text-white bg-emerald-500 hover:bg-emerald-600 disabled:bg-emerald-500/50 disabled:cursor-not-allowed rounded-2xl transition-colors"
									>
										{m.comment_update()}
									</button>
								</div>
