	...
	return (
		<div className="px-8 py-4 animate-skeleton-pulse pointer-events-none">
			...
			<div className={`flex flex-wrap gap-2 mb-3 ${indent}`}>
				<div className="h-6 w-16 bg-neutral-800/40 rounded-lg" />
				<div className="h-6 w-12 bg-neutral-800/40 rounded-lg" />
			</div>

			<div className={`${noIndent ? "" : "ml-11"} flex items-center gap-3`}>
				<div className="h-6 w-24 bg-neutral-800/40 rounded-lg" />
				<div className="h-6 w-16 bg-neutral-800/40 rounded-lg" />
			</div>
		</div>
	);
