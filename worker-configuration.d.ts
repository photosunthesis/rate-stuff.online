/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e5d56488f33fa85d632d6b4c546968a0)
// Runtime types generated with workerd@1.20251213.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SESSION_SECRET: string;
		DATABASE_URL: string;
		rate_stuff_online_r2: R2Bucket;
		rate_stuff_online_db: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "DATABASE_URL">> {}
}
