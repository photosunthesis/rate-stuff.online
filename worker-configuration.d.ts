/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d505669cfb0fad82b04f896d5372b9c)
// Runtime types generated with workerd@1.20251213.0 2025-09-02 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ActivityNotifications";
	}
	interface Env {
		DATABASE_URL: string;
		...
		VITE_IMAGEKIT_URL_ENDPOINT: string;
		IMAGEKIT_PUBLIC_KEY: string;
		IMAGEKIT_PRIVATE_KEY: string;
		VITE_SENTRY_DSN: string;
		ACTIVITY_NOTIFICATIONS: DurableObjectNamespace<import("./src/server").ActivityNotifications>;
		R2_BUCKET: R2Bucket;
		GENERAL: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "VITE_UMAMI_URL" | "VITE_UMAMI_WEBSITE_ID" | "VITE_IMAGEKIT_URL_ENDPOINT" | "IMAGEKIT_PUBLIC_KEY" | "IMAGEKIT_PRIVATE_KEY" | "VITE_SENTRY_DSN">> {}
}
